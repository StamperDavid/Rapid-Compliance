...
**Last Updated:** April 26, 2026 (afternoon) — **Bluesky live end-to-end. Inbound DM architecture redesigned: dispatcher → specialist direct (skips Jasper + manager) for DMs only. compose_dm_reply now on 6 specialists via shared mixin. Training loop validated.** Major changes today (afternoon):
