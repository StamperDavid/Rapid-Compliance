...
export const FEATURE_MODULES: FeatureModuleDefinition[] = [
  ...
  },
  {
    ...
    icon: 'Store',
    defaultEnabled: true,
    description: 'Add an online store to your website for selling products or services.',
    whyItMatters: 'Let customers browse and purchase directly from your website — no separate e-commerce platform needed.',
...
export const INDUSTRY_FEATURE_DEFAULTS: Record<string, FeatureModuleId[]> = {
  ...
  ecommerce_retail: [...ALWAYS_ON, 'storefront', 'email_outreach', 'social_media', 'website_builder', 'advanced_analytics', 'video_production'],
  ...
  hospitality_food: [...ALWAYS_ON, 'email_outreach', 'social_media', 'forms_surveys', 'website_builder', 'storefront', 'video_production'],
