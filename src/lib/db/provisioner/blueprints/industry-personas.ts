/**
 * Industry Personas Blueprints
 *
 * 12 industry-specific AI personality configurations.
 * Each persona is tailored to the unique communication needs
 * and operational focus of different business verticals.
 *
 * Source: Mirrors INDUSTRY_PERSONAS from src/lib/ai/persona-mapper.ts
 */

import type { IndustryPersonaBlueprint } from '../types';

/**
 * Blueprint version - increment when making changes
 */
export const INDUSTRY_PERSONAS_VERSION = 1;

/**
 * All industry persona blueprints
 */
export const INDUSTRY_PERSONA_BLUEPRINTS: Record<string, IndustryPersonaBlueprint> = {
  ...
  service: {
    ...
    version: INDUSTRY_PERSONAS_VERSION,
  },
...
/**
 * Get all industry persona blueprints
 */
export function getIndustryPersonaBlueprints(): Record<string, IndustryPersonaBlueprint> {
  return { ...INDUSTRY_PERSONA_BLUEPRINTS };
}

/**
 * Get a specific industry persona blueprint
 */
export function getIndustryPersonaBlueprint(industryId: string): IndustryPersonaBlueprint | null {
  return INDUSTRY_PERSONA_BLUEPRINTS[industryId] ?? null;
}
...
export function getIndustryIds(): string[] {
  return Object.keys(INDUSTRY_PERSONA_BLUEPRINTS);
}
