  ...
  purchase_flow: {
    ...
    steps: [
      ...
      },
      {
        id: 'recommend_tier1',
        type: 'question',
        question: 'Based on your needs, our $299/month plan with ALL features included is perfect. Does that work?',
      ...
      },
      {
        id: 'recommend_tier2',
        type: 'question',
        question: 'Our $299/month plan includes everything — unlimited AI agents, full CRM, automation, and more. Sound good?',
        requiredInfo: 'planAccepted',
        nextStepId: 'create_checkout',
      },
      {
        id: 'recommend_tier3',
        type: 'question',
        question: 'For your scale, our $299/month flat plan has the entire platform. Ready to get started?',
        requiredInfo: 'planAccepted',
        nextStepId: 'create_checkout',
      },
      {
