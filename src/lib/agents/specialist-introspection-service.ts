...
const MARKETING_SPECIALIST_DIRECTORY: Record<string, AgentDefinition> = {
  ...
  // grid (Threads / WhatsApp). Their files + GMs are seeded; registering
  // them here keeps the introspection lookups working for any future
  // toggle that re-enables those platforms in the UI.
  THREADS_EXPERT: {
    id: 'THREADS_EXPERT',
    name: 'Threads Expert',
    role: 'specialist',
