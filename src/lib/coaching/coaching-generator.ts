...
export class CoachingGenerator {
  ...
  async generateCoachingInsights(
    ...
    try {
      ...
      logger.error('Error generating coaching insights', errorObj, {
        repId: performance.repId
      });
      throw error;
    }
  ...
  private async generatePerformanceSummary(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing performance summary', errorObj);
  ...
  private async identifyStrengths(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing strengths', errorObj);
  ...
  private async identifyWeaknesses(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing weaknesses', errorObj);
  ...
  private async identifyOpportunities(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing opportunities', errorObj);
  ...
  private async assessRisks(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing risks', errorObj);
  ...
  private async identifyBestPractices(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing best practices', errorObj);
      return [];
    }
  }
  ...
  private async generateRecommendations(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing recommendations', errorObj);
  ...
  private async generateTrainingSuggestions(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing training suggestions', errorObj);
      return [];
    }
  }
  ...
  private async generateActionItems(
    ...
    try {
      ...
      const errorObj = error instanceof Error ? error : new Error(String(error));
      logger.error('Error parsing action items', errorObj);
      return [];
    }
  }
