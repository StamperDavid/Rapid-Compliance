...
export class ApprovalService {
  ...
  static async createApproval(data: {
    ...
    await AdminFirestoreService.setLikeClient(approvalsPath(), approvalId, item, false);
  ...
  static async updateStatus(
    ...
    await AdminFirestoreService.updateLikeClient(approvalsPath(), approvalId, updates);
  ...
  static async addComment(
    ...
    await AdminFirestoreService.updateLikeClient(approvalsPath(), approvalId, {
