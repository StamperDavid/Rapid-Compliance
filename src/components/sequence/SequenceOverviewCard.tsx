...
export function SequenceOverviewCard({ analysis }: SequenceOverviewCardProps) {
  ...
  return (
    <div className="bg-surface-main rounded-lg shadow p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-[var(--color-text-primary)]">Sequence Overview</h2>
      ...
      <div className="border-t border-border-light pt-6">
        <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">Performance Summary</h3>
      ...
      {analysis.aiInsights && (
        <div className="border-t border-border-light mt-6 pt-6">
          <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">AI Insights</h3>

          {analysis.aiInsights.keyFindings.length > 0 && (
            <div className="mb-4">
              <h4 className="text-sm font-medium text-[var(--color-text-secondary)] mb-2">Key Findings</h4>
          ...
          {analysis.aiInsights.concerns.length > 0 && (
            <div className="mb-4">
              <h4 className="text-sm font-medium text-[var(--color-text-secondary)] mb-2">Concerns</h4>
              <ul className="space-y-1">
          ...
          {analysis.aiInsights.opportunities.length > 0 && (
            <div className="mb-4">
              <h4 className="text-sm font-medium text-[var(--color-text-secondary)] mb-2">Opportunities</h4>
              <ul className="space-y-1">
  ...
  return (
    <div className="bg-surface-elevated rounded-lg p-4">
      <div className="flex items-center justify-between mb-2">
        <Icon className="w-5 h-5 text-[var(--color-text-disabled)]" />
        {trend && (
          <div className={`flex items-center text-xs ${trend === 'up' ? 'text-success' : 'text-error'}`}>
            {trend === 'up' ? (
  ...
  return (
    <div className="flex items-start justify-between">
      <div>
        ...
        <div className="text-sm text-[var(--color-text-primary)] mt-1">{value}</div>
      </div>
      <div className={`text-xs px-2 py-1 rounded ${positive ? 'bg-surface-elevated text-success' : 'bg-surface-elevated text-warning'}`}>
        {metric}
      </div>
    </div>
  );
