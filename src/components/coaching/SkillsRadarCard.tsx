...
export function SkillsRadarCard({ skills, loading = false }: SkillsRadarCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Skills Assessment</h3>
        <p className="text-sm text-gray-500">Performance across 12 key competencies</p>
      </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="flex items-center justify-between text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">0-40: Needs Focus</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
            <span className="text-gray-600">40-70: Developing</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-green-500"></div>
            <span className="text-gray-600">70-100: Proficient</span>
          </div>
        </div>
      </div>
    </div>
