  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">{teamName} · {summary.totalReps} reps</p>
      </div>
          ...
          {summary.performanceDistribution.map((dist) => (
            <div key={dist.tier}>
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-gray-600">{getTierLabel(dist.tier)}</span>
      ...
      {/* Team Averages */}
      <div className="mb-6">
        <h4 className="text-sm font-medium text-gray-700 mb-3">Team Averages</h4>
      ...
      {summary.topPerformerBenchmarks.length > 0 && (
        <div className="mt-6 pt-6 border-t border-gray-200">
          <h4 className="text-sm font-medium text-gray-700 mb-3">Top Performer Benchmarks</h4>
          <div className="grid grid-cols-2 gap-3">
            {summary.topPerformerBenchmarks.slice(0, 4).map((benchmark, idx) => (
              <div key={idx} className="bg-green-50 rounded-lg p-3">
                <div className="text-xs text-green-700 mb-1">{benchmark.metric}</div>
