...
export function DevelopmentPlanCard({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Development Plan</h3>
        <p className="text-sm text-gray-500">Prioritized coaching areas for your team</p>
      </div>
        ...
        <div className="mb-6">
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4">
            ...
            <div className="space-y-2">
              {atRiskReps.map((rep) => (
                <div key={rep.repId} className="bg-white rounded-lg p-3 border border-red-200">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      <h5 className="text-sm font-semibold text-gray-900">{rep.repName}</h5>
                      <p className="text-xs text-gray-500">Performance Score: {rep.score.toFixed(0)}</p>
                    </div>
      ...
      {/* Team Priorities */}
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-3">Team Coaching Priorities</h4>
        
        {priorities.length === 0 ? (
          <div className="text-center py-8">
            <span className="text-4xl mb-3 block">✅</span>
            <p className="text-gray-600">Team is performing well</p>
            <p className="text-sm text-gray-500 mt-1">No critical coaching priorities identified</p>
          </div>
        ) : (
              ...
              return (
                <div key={idx} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h5 className="text-sm font-semibold text-gray-900">{priority.area}</h5>
                  ...
                  <div className="mb-3">
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-gray-500 min-w-[80px]">Importance:</span>
                      ...
                      <span className="text-xs font-semibold text-gray-900 min-w-[40px] text-right">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
          <div className="flex items-start gap-3">
            <span className="text-2xl">🎯</span>
            <div>
              <h4 className="text-sm font-semibold text-blue-900 mb-1">Recommended Next Steps</h4>
