      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: "templates",
            label: "Templates",
            href: `/admin/templates?org=${organizationId}`,
            icon: FileText,
        ...
        items: [
          {
            ...
            href: `/admin/voice?org=${organizationId}`,
            icon: SettingsIcon,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: "revenue",
            label: "Revenue",
            href: `/admin/revenue?org=${organizationId}`,
            icon: DollarSign,
        ...
        items: [
          {
            id: "persona",
            label: "Persona",
            href: `/admin/sales-agent/persona?org=${organizationId}`,
            icon: UserCog,
          ...
          },
          {
            id: "jasper-training",
            label: "Training",
            href: `/admin/sales-agent/training?org=${organizationId}`,
            icon: GraduationCap,
          ...
          },
          {
            ...
            href: `/admin/sales-agent/knowledge?org=${organizationId}`,
            icon: Book,
