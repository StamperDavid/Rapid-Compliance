        ...
        items: [
          {
            id: "overview",
            label: "Overview",
            href: `/dashboard/command-center?org=${organizationId}`,
            icon: LayoutDashboard,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: "users",
            label: "Users",
            href: `/dashboard/users?org=${organizationId}`,
            icon: Users,
        ...
        items: [
          {
            id: "leads",
            label: "Leads",
            href: `/dashboard/leads?org=${organizationId}`,
            icon: Target,
          ...
          },
          {
            id: "deals",
            label: "Deals",
            href: `/dashboard/deals?org=${organizationId}`,
            icon: Handshake,
          ...
          },
          {
            id: "sales-agent",
            label: "Sales Agent",
            href: `/dashboard/sales-agent?org=${organizationId}`,
            icon: Bot,
          ...
          },
          {
            id: "recovery",
            label: "Recovery",
            href: `/dashboard/recovery?org=${organizationId}`,
            icon: RotateCcw,
        ...
        items: [
          {
            id: "social",
            label: "Social Posts",
            href: `/dashboard/social?org=${organizationId}`,
            icon: Share2,
          ...
          },
          {
            id: "swarm",
            label: "Swarm Control",
            href: `/dashboard/swarm?org=${organizationId}`,
            icon: GitBranch,
        ...
        items: [
          {
            id: "campaigns",
            label: "Campaigns",
            href: `/dashboard/email-campaigns?org=${organizationId}`,
            icon: Mail,
          ...
          },
          {
            id: "templates",
            label: "Templates",
            href: `/dashboard/email-templates?org=${organizationId}`,
            icon: FileText,
        ...
        items: [
          {
            ...
            href: `/dashboard/voice-settings?org=${organizationId}`,
            icon: SettingsIcon,
          ...
          },
          {
            id: "training",
            label: "Training",
            href: `/dashboard/voice-training?org=${organizationId}`,
            icon: GraduationCap,
        ...
        items: [
          {
            id: "usage",
            label: "Usage",
            href: `/dashboard/analytics/usage?org=${organizationId}`,
            icon: Activity,
          ...
          },
          {
            id: "revenue",
            label: "Revenue",
            href: `/dashboard/analytics/revenue?org=${organizationId}`,
            icon: DollarSign,
          ...
          },
          {
            id: "pipeline",
            label: "Pipeline",
            href: `/dashboard/analytics/pipeline?org=${organizationId}`,
            icon: TrendingUp,
        ...
        items: [
          {
            id: "health",
            label: "Health",
            href: `/dashboard/system/health?org=${organizationId}`,
            icon: Activity,
          ...
          },
          {
            id: "api-keys",
            label: "API Keys",
            href: `/dashboard/system/api-keys?org=${organizationId}`,
            icon: Key,
          ...
          },
          {
            id: "flags",
            label: "Feature Flags",
            href: `/dashboard/system/flags?org=${organizationId}`,
            icon: Flag,
          ...
          },
          {
            id: "logs",
            label: "Logs",
            href: `/dashboard/system/logs?org=${organizationId}`,
            icon: FileCode,
            tooltip: "System Logs",
          },
          {
            id: "settings",
            label: "Settings",
            href: `/dashboard/system/settings?org=${organizationId}`,
            icon: SettingsIcon,
        ...
        items: [
          {
            id: "persona",
            label: "Persona",
            href: `/dashboard/jasper/persona?org=${organizationId}`,
            icon: UserCog,
          ...
          },
          {
            id: "jasper-training",
            label: "Training",
            href: `/dashboard/jasper/training?org=${organizationId}`,
            icon: GraduationCap,
          ...
          },
          {
            ...
            href: `/dashboard/jasper/knowledge?org=${organizationId}`,
            icon: Book,
