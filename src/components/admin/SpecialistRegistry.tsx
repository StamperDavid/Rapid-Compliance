...
const SPECIALIST_REGISTRY: AISpecialist[] = [
  ...
  },
  {
    ...
    category: 'marketing',
    status: 'FUNCTIONAL',
    description: 'Develops professional content and engagement strategies for LinkedIn',
    capabilities: [
  ...
  // Outreach Category (2 specialists)
  {
    ...
    category: 'outreach',
    status: 'FUNCTIONAL',
    description: 'Creates and optimizes email campaigns for engagement and conversion',
    capabilities: [
      'Email copywriting',
  ...
  },
  {
    ...
    category: 'trust',
    status: 'FUNCTIONAL',
    description: 'Optimizes Google My Business listings for local visibility',
    capabilities: [
