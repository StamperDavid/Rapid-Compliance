...
export default function Tooltip({ 
  ...
  const arrowPosition = {
    top: {
      ...
      borderColor: 'var(--color-bg-elevated) transparent transparent transparent',
    },
    bottom: {
      bottom: '100%',
      left: '50%',
      ...
      borderColor: 'transparent transparent var(--color-bg-elevated) transparent',
    },
    left: {
      left: '100%',
      top: '50%',
      ...
      borderColor: 'transparent transparent transparent var(--color-bg-elevated)',
    },
    right: {
      right: '100%',
      top: '50%',
      ...
      borderColor: 'transparent var(--color-bg-elevated) transparent transparent',
    },
  };
