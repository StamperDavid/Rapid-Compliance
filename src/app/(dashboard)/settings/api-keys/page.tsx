...
export default function APIKeysPage() {
  ...
  const services = [
    ...
    {
      id: 'fal',
      name: 'fal.ai (Seedance)',
      icon: '🎬',
      description: 'AI video generation (Seedance — reference-to-video, scene chaining) + image generation (Flux, SDXL, Flux Kontext editing)',
      required: false,
      placeholder: 'fal_...',
      setupUrl: 'https://fal.ai/dashboard/keys',
      setupSteps: [
        'Go to fal.ai and sign up',
        'Open the Dashboard → API Keys page',
        'Create a new API key',
        'Copy your API key and paste here',
      ],
      cost: 'Pay-as-you-go — per-generation pricing (see fal.ai/pricing)',
      why: 'The video engine. Generate videos with Seedance (cast a saved character into new scenes, with last-frame chaining) and images with Flux.',
    },
    {
      id: 'minimax',
