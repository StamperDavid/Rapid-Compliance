...
export default function APIKeysPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      name: 'Runway',
      icon: '🎥',
      description: 'AI video generation (Gen-4.5)',
      required: false,
      placeholder: 'key_...',
      setupUrl: 'https://dev.runwayml.com',
      setupSteps: [
        'Go to dev.runwayml.com',
        'Sign up or log in',
        'Create an API key',
        'Copy and paste here',
      ],
      cost: 'Plans start at $12/month',
      why: 'Generate cinematic AI video content for B-roll, product demos, and social ads.',
    },
    {
      id: 'sora',
      name: 'OpenAI Sora',
      icon: '✨',
      description: 'OpenAI text-to-video generation (Sora 2)',
      required: false,
      placeholder: 'sk-...',
      setupUrl: 'https://platform.openai.com/api-keys',
      setupSteps: [
      ...
      cost: 'Pay-as-you-go (OpenAI pricing)',
      why: 'Generate AI video content with realistic motion for storytelling and wide shots.',
    },
    {
      id: 'fal',
      name: 'fal.ai (Kling 3.0)',
      icon: '🎬',
      description: 'Full-body avatar video, character consistency (Kling 3.0 via fal.ai)',
      required: false,
      placeholder: 'faa...:...',
      setupUrl: 'https://fal.ai/dashboard/keys',
      setupSteps: [
        'Go to fal.ai',
        'Sign up (company, Build with Code)',
        'Dashboard → Keys',
        'Create a new key',
        'Copy and paste here',
      ],
      cost: 'Pay-per-use: $0.07-$0.39/sec depending on model',
    ...
    },
    {
      ...
      icon: '🚀',
      description: 'Real site speed scores, Core Web Vitals, and mobile readiness data for SEO',
      required: false,
      placeholder: 'AIzaSy...',
      ...
      cost: 'FREE — 25K requests/day with key, 100/day without',
      why: 'Powers SEO crawl analysis with real performance scores, Core Web Vitals (LCP, CLS, TBT), and mobile readiness checks.',
    },
    {
      id: 'dataforseo_login',
      name: 'DataForSEO Login',
      icon: '📈',
      description: 'Real keyword volume, difficulty, SERP data, and domain metrics for SEO',
      required: false,
      placeholder: 'your-email@example.com',
      setupUrl: 'https://dataforseo.com',
      setupSteps: [
        'Go to dataforseo.com and sign up',
        'Dashboard → API credentials',
        'Copy your login email and paste here',
      ],
      cost: 'Free $1 trial credit, then pay-as-you-go',
      why: 'Powers keyword research with real search volumes, CPC, competition levels, and competitor domain metrics.',
    },
    {
      id: 'dataforseo_password',
      name: 'DataForSEO Password',
      icon: '🔐',
      description: 'API password for DataForSEO (not your account password)',
      required: false,
      placeholder: 'your-api-password',
      setupUrl: 'https://dataforseo.com',
      setupSteps: [
        'Same dashboard as DataForSEO Login',
        'Copy your API password (NOT your account password)',
        'Paste here',
      ],
      cost: 'FREE (goes with login)',
      why: 'Needed with DataForSEO Login. These are a pair.',
    },
    {
      id: 'newsapi',
      name: 'NewsAPI',
    ...
    },
    {
      ...
      icon: '🐦',
      description: 'Twitter/X API v2 consumer key (API Key)',
      required: false,
      placeholder: 'xX7rl...',
      ...
      setupSteps: [
        ...
        'Keys and Tokens → Consumer Keys',
        'Copy the API Key (Consumer Key) and paste here',
      ],
      cost: 'FREE tier available (Basic: $100/month for higher limits)',
      why: 'Powers social media posting, monitoring, and engagement on Twitter/X.',
    },
    {
      id: 'twitter_consumer_secret',
      name: 'Twitter/X Consumer Secret',
      icon: '🔐',
      description: 'Goes with Twitter/X Consumer Key',
      required: false,
      placeholder: 'QF4wJ...',
      setupUrl: 'https://developer.x.com',
      setupSteps: [
        'Same place as Consumer Key',
        'Copy the API Secret (Consumer Secret) and paste here',
      ],
      cost: 'FREE',
      why: 'Needed with Consumer Key. These are a pair.',
    },
    {
      id: 'twitter_access_token',
      name: 'Twitter/X Access Token',
      icon: '🐦',
      description: 'Twitter/X access token for posting on behalf of your account',
      required: false,
      placeholder: '20267...',
      setupUrl: 'https://developer.x.com',
      setupSteps: [
        'Same app page in developer.x.com',
        'Keys and Tokens → Authentication Tokens',
        'Generate Access Token and Secret',
        'Copy the Access Token and paste here',
      ],
      cost: 'FREE',
      why: 'Allows the app to post tweets and interact as your account.',
    },
    {
      id: 'twitter_access_secret',
      name: 'Twitter/X Access Token Secret',
      icon: '🔐',
      description: 'Goes with Twitter/X Access Token',
      required: false,
      placeholder: 'igmUO...',
      setupUrl: 'https://developer.x.com',
      setupSteps: [
        'Same place as Access Token',
        'Copy the Access Token Secret and paste here',
      ],
      cost: 'FREE',
      why: 'Needed with Access Token. These are a pair.',
    },
  ];
