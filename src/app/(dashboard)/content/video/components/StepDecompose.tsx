          ...
          {decompositionPlan && !isLoading && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {decompositionPlan.generatedBy && (
                  <div className="p-3 bg-zinc-800/50 rounded-lg">
                    <p className="text-xs text-zinc-400">Generated By</p>
                    <p className={`text-sm font-medium ${decompositionPlan.generatedBy === 'ai' ? 'text-green-400' : 'text-zinc-400'}`}>
                      {decompositionPlan.generatedBy === 'ai' ? 'AI Scriptwriter' : 'Template'}
                    </p>
                  </div>
                )}
              </div>
