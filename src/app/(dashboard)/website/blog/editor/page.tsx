              ...
              <div style={{ overflowY: 'auto', padding: '1.5rem', height: '100%' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  ...
                  <div>
                    ...
                    {/* Show a preview whenever a URL is set — cached DALL-E
                        output from the content pipeline lives at
                        /api/website/blog/featured-image/{postId}; operators
                        uploading their own image just paste a URL. */}
                    {post.featuredImage && (
                      <div style={{
                        marginBottom: '0.5rem',
                        borderRadius: '6px',
                    ...
                    {!post.featuredImage && (
                      <div style={{
                        ...
                        Auto-generated by the content pipeline on mission completion.
                      </div>
                    )}
                  </div>
