    ...
    <div className="p-8">
      <div className="mb-6">
        ...
        <div className="flex items-start gap-6">
          <div className="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-3xl font-bold">{displayInitial}</div>
        ...
        <div className="col-span-2 space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><div className="text-sm text-gray-400 mb-1">Phone</div><div>{displayPhone || '-'}</div></div>
          ...
          <div className="bg-gray-900 rounded-lg p-6">
            ...
            <div className="space-y-3">
              {lastActivityDate ? (
                <div className="bg-gray-800 rounded p-3"><div className="text-sm text-gray-400">Last Activity: {lastActivityDate.toLocaleString()}</div></div>
              ) : (
        ...
        <div className="space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            ...
            <div className="space-y-2">
              ...
              <button
                onClick={() => router.push(`/workspace/${orgId}/calls/make?phone=${encodeURIComponent(displayPhone)}&contactId=${contactId}`)}
