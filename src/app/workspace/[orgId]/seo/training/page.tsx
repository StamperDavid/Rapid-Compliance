...
export default function SEOTrainingPage() {
  ...
  const loadData = async () => {
    try {
      ...
      logger.error('Error loading SEO training data:', error, { file: 'seo/training/page.tsx' });
      loadDemoData();
    } finally {
      setLoading(false);
    }
  ...
  const handleSaveSettings = async () => {
    try {
      ...
      logger.error('Error saving SEO settings:', error, { file: 'seo/training/page.tsx' });
  ...
  const generateContent = async (type: 'outline' | 'article') => {
    ...
    try {
      ...
      logger.error('Error generating SEO content:', error, { file: 'seo/training/page.tsx' });
  ...
  const saveToHistory = async (topic: string, type: 'outline' | 'article', seoScore: number) => {
    try {
      ...
      logger.error('Error saving to history:', error, { file: 'seo/training/page.tsx' });
    }
  };
