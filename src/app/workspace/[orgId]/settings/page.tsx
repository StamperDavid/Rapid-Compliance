...
export default function SettingsPage() {
  ...
  const settingsSections = [
    ...
    },
    {
      ...
      items: [
        { icon: '📈', label: 'Analytics Dashboard', description: 'Revenue reports, pipeline analysis, forecasting, and win/loss', href: `/workspace/${orgId}/analytics`, permission: canManageOrganization },
      ]
    },
    {
