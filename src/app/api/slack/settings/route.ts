...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('Failed to get Slack settings', error instanceof Error ? error : new Error(String(error)));
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error('Failed to update Slack settings', error instanceof Error ? error : new Error(String(error)));
