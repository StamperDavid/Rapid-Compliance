...
const SERVICE_CAPABILITY_MAP: Record<string, ServiceCheck> = {
  ...
  fal:          { label: 'Fal.ai',                         capability: 'AI video (Seedance) + image generation (Flux, SDXL)', setupGuide: 'Go to fal.ai/dashboard/keys, create an API key, and paste it in Settings > API Keys under "Fal.ai".' },
