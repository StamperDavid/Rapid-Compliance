...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('Checkout processing error', error instanceof Error ? error : new Error(String(error)), { route: '/api/ecommerce/checkout' });
    return errors.externalService('Checkout service', error instanceof Error ? error : new Error(String(error)));
  }
}
