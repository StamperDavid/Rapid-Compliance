 ...
 *
 * What this DOES test:
 *   - The Calendar Coordinator loads its systemPrompt from Firestore at runtime
 ...
 *     pass this test)
 *
 * Renamed Apr 29 2026 from `verify-calendar-coordinator-is-real.js` because
 ...
 * `verify-prompt-matrix-e2e.ts` that should route to CALENDAR_COORDINATOR.
 *
 ...
 *     frequencyRecommendation values → THE GM IS BEING LOADED. The output
