  ...
  return [
    {
      ...
      scenes: [
        { id: 'scene-001', sceneNumber: 1, scriptText: 'Welcome to SalesVelocity.ai — the AI-powered sales platform that transforms how your team sells.', screenshotUrl: null, avatarId: null, voiceId: null, duration: 15, engine: 'fal', status: 'completed' },
        { id: 'scene-002', sceneNumber: 2, scriptText: 'Let me show you how our AI coaching engine analyzes every conversation and provides real-time coaching tips.', screenshotUrl: null, avatarId: null, voiceId: null, duration: 30, engine: 'fal', status: 'completed' },
        { id: 'scene-003', sceneNumber: 3, scriptText: 'With our Growth Command Center, you can monitor competitors, track keyword rankings, and get AI-generated strategies.', screenshotUrl: null, avatarId: null, voiceId: null, duration: 35, engine: 'fal', status: 'completed' },
        { id: 'scene-004', sceneNumber: 4, scriptText: 'Ready to transform your sales? Start your free trial at SalesVelocity.ai today.', screenshotUrl: null, avatarId: null, voiceId: null, duration: 15, engine: 'fal', status: 'completed' },
      ],
      avatarId: null,
      avatarName: null,
      voiceId: null,
      voiceName: null,
      generatedScenes: [
        { sceneId: 'scene-001', providerVideoId: 'hg-demo-001', provider: 'fal', status: 'completed', videoUrl: 'https://storage.example.com/videos/demo-scene-001.mp4', thumbnailUrl: 'https://storage.example.com/thumbs/demo-scene-001.jpg', progress: 100, error: null },
        { sceneId: 'scene-002', providerVideoId: 'hg-demo-002', provider: 'fal', status: 'completed', videoUrl: 'https://storage.example.com/videos/demo-scene-002.mp4', thumbnailUrl: 'https://storage.example.com/thumbs/demo-scene-002.jpg', progress: 100, error: null },
        { sceneId: 'scene-003', providerVideoId: 'hg-demo-003', provider: 'fal', status: 'completed', videoUrl: 'https://storage.example.com/videos/demo-scene-003.mp4', thumbnailUrl: 'https://storage.example.com/thumbs/demo-scene-003.jpg', progress: 100, error: null },
        { sceneId: 'scene-004', providerVideoId: 'hg-demo-004', provider: 'fal', status: 'completed', videoUrl: 'https://storage.example.com/videos/demo-scene-004.mp4', thumbnailUrl: 'https://storage.example.com/thumbs/demo-scene-004.jpg', progress: 100, error: null },
      ],
