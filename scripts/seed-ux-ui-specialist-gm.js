/**
 * Seed UX/UI Specialist Golden Master v1 (saas_sales_ops) — direct Firestore admin
 *
 * Usage: node scripts/seed-ux-ui-specialist-gm.js [--force]
 *
...
async function main() {
  ...
  if (!existing.empty && !force) {
    console.log(`✓ UX/UI Specialist GM already active: ${existing.docs[0].id} — skipping (pass --force to overwrite)`);
    process.exit(0);
  }
