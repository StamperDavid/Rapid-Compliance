 ...
 *
 * What this DOES test:
 *   - The UX/UI Specialist loads its systemPrompt from Firestore at runtime
 ...
 *     pass this test)
 *
 * Renamed Apr 29 2026 from `verify-ux-ui-specialist-is-real.js` because
 ...
 * `verify-prompt-matrix-e2e.ts` that should route to UX_UI_SPECIALIST.
 */
