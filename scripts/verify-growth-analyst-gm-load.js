 ...
 *
 * What this DOES test:
 *   - The Growth Analyst loads its systemPrompt from Firestore at runtime
 ...
 *     pass this test)
 *
 * Renamed Apr 29 2026 from `verify-growth-analyst-is-real.js` because
 ...
 * `verify-prompt-matrix-e2e.ts` that should route to GROWTH_ANALYST.
 */
