 ...
 *
 * What this DOES test:
 *   - The SMS Specialist loads its systemPrompt from Firestore at runtime
 ...
 *     pass this test)
 *
 * Renamed Apr 29 2026 from `verify-sms-specialist-is-real.js` because
 ...
 * `verify-outreach-orchestrated-live.ts` that should route to SMS_SPECIALIST.
 */
