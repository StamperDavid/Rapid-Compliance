...
function getOrders(): Array<Record<string, unknown>> {
  return [
    {
      id: 'demo-order-001', isDemo: true, orderNumber: 'DEMO-ORD-1001', status: 'completed',
      customerEmail: 'jchen@luminarydesigns.co',
      customer: { firstName: '(Demo) Jessica', lastName: 'Chen', email: 'jchen@luminarydesigns.co', phone: '(555) 345-6789' },
      items: [
        { id: 'demo-oi-001-1', productId: 'demo-product-001', productName: '(Demo) Growth Plan — Monthly', sku: 'PLAN-GROWTH-MO', price: 14900, quantity: 1, subtotal: 14900, tax: 1192, discount: 2235, total: 13857, fulfillmentStatus: 'fulfilled', quantityFulfilled: 1, refunded: false },
        { id: 'demo-oi-001-2', productId: 'demo-product-004', productName: '(Demo) Data Migration Service', sku: 'SVC-MIGRATE', price: 49900, quantity: 1, subtotal: 49900, tax: 3992, discount: 7485, total: 46407, fulfillmentStatus: 'fulfilled', quantityFulfilled: 1, refunded: false },
      ],
      subtotal: 64800, tax: 5184, shipping: 0, discount: 9720, total: 60264,
      payment: { method: 'card', provider: 'stripe', transactionId: 'pi_demo_001', status: 'captured', cardLast4: '4242', cardBrand: 'visa', processedAt: daysAgo(22), capturedAt: daysAgo(22), amountCharged: 60264, amountRefunded: 0 },
      shippingAddress: null, billingAddress: { street: '456 Design Ave', city: 'Portland', state: 'OR', zip: '97201', country: 'US' },
      shippingInfo: { method: 'digital_delivery', methodId: 'digital', cost: 0 },
      fulfillmentStatus: 'fulfilled', paymentStatus: 'captured',
      customerNotes: '', internalNotes: '(Demo) Annual billing applied. Migration completed within 3 business days.',
      source: 'web', tags: ['enterprise', 'annual', 'migration'],
      createdBy: DEMO_OWNER_ID,
      createdAt: daysAgo(22), updatedAt: daysAgo(18),
    },
    {
      id: 'demo-order-002', isDemo: true, orderNumber: 'DEMO-ORD-1002', status: 'processing',
      customerEmail: 'dpark@cloudnine.dev',
      customer: { firstName: '(Demo) David', lastName: 'Park', email: 'dpark@cloudnine.dev', phone: '(555) 567-8901' },
      items: [
        { id: 'demo-oi-002-1', productId: 'demo-product-002', productName: '(Demo) Enterprise Plan — Monthly', sku: 'PLAN-ENT-MO', price: 39900, quantity: 1, subtotal: 39900, tax: 3192, discount: 0, total: 43092, fulfillmentStatus: 'unfulfilled', quantityFulfilled: 0, refunded: false },
      ],
      subtotal: 39900, tax: 3192, shipping: 0, discount: 0, total: 43092,
      payment: { method: 'card', provider: 'stripe', transactionId: 'pi_demo_002', status: 'captured', cardLast4: '5555', cardBrand: 'mastercard', processedAt: daysAgo(5), capturedAt: daysAgo(5), amountCharged: 43092, amountRefunded: 0 },
      shippingAddress: null, billingAddress: { street: '789 Cloud St', city: 'Austin', state: 'TX', zip: '73301', country: 'US' },
      shippingInfo: { method: 'digital_delivery', methodId: 'digital', cost: 0 },
      fulfillmentStatus: 'unfulfilled', paymentStatus: 'captured',
      customerNotes: '', internalNotes: '(Demo) Enterprise onboarding in progress.',
      source: 'web', tags: ['enterprise'],
      createdBy: DEMO_OWNER_ID,
      createdAt: daysAgo(5), updatedAt: daysAgo(3),
    },
    {
      id: 'demo-order-003', isDemo: true, orderNumber: 'DEMO-ORD-1003', status: 'processing',
      customerEmail: 'tbradley@fitlife.com',
      customer: { firstName: '(Demo) Tom', lastName: 'Bradley', email: 'tbradley@fitlife.com', phone: '(555) 890-1234' },
      items: [
        { id: 'demo-oi-003-1', productId: 'demo-product-003', productName: '(Demo) Starter Plan — Monthly', sku: 'PLAN-START-MO', price: 9900, quantity: 1, subtotal: 9900, tax: 792, discount: 0, total: 10692, fulfillmentStatus: 'unfulfilled', quantityFulfilled: 0, refunded: false },
        { id: 'demo-oi-003-2', productId: 'demo-product-005', productName: '(Demo) Custom AI Training Session', sku: 'SVC-AI-TRAIN', price: 29900, quantity: 2, subtotal: 59800, tax: 4784, discount: 0, total: 64584, fulfillmentStatus: 'unfulfilled', quantityFulfilled: 0, refunded: false },
      ],
      subtotal: 69700, tax: 5576, shipping: 0, discount: 0, total: 75276,
      payment: { method: 'card', provider: 'stripe', transactionId: 'pi_demo_003', status: 'captured', cardLast4: '1234', cardBrand: 'amex', processedAt: daysAgo(1), capturedAt: daysAgo(1), amountCharged: 75276, amountRefunded: 0 },
      shippingAddress: null, billingAddress: { street: '321 Wellness Blvd', city: 'Denver', state: 'CO', zip: '80201', country: 'US' },
      shippingInfo: { method: 'digital_delivery', methodId: 'digital', cost: 0 },
      fulfillmentStatus: 'unfulfilled', paymentStatus: 'captured',
      customerNotes: '', internalNotes: '(Demo) Training sessions scheduled for next week.',
      source: 'web', tags: ['starter', 'training'],
      createdBy: DEMO_OWNER_ID,
      createdAt: daysAgo(1), updatedAt: now,
    },
    {
      id: 'demo-order-004', isDemo: true, orderNumber: 'DEMO-ORD-1004', status: 'pending',
      customerEmail: 'rkim@suncoastrealty.com',
      customer: { firstName: '(Demo) Rachel', lastName: 'Kim', email: 'rkim@suncoastrealty.com', phone: '(555) 456-7890' },
      items: [
        { id: 'demo-oi-004-1', productId: 'demo-product-001', productName: '(Demo) Growth Plan — Monthly', sku: 'PLAN-GROWTH-MO', price: 14900, quantity: 1, subtotal: 14900, tax: 1192, discount: 2980, total: 13112, fulfillmentStatus: 'unfulfilled', quantityFulfilled: 0, refunded: false },
      ],
      subtotal: 14900, tax: 1192, shipping: 0, discount: 2980, total: 13112,
      payment: { method: 'card', provider: 'stripe', transactionId: null, status: 'pending', amountCharged: 0, amountRefunded: 0 },
      shippingAddress: null, billingAddress: { street: '555 Beach Dr', city: 'Tampa', state: 'FL', zip: '33601', country: 'US' },
      shippingInfo: { method: 'digital_delivery', methodId: 'digital', cost: 0 },
      fulfillmentStatus: 'unfulfilled', paymentStatus: 'pending',
      customerNotes: '', internalNotes: '(Demo) Awaiting payment confirmation.',
      source: 'web', tags: ['real-estate', 'discount'],
      createdBy: DEMO_OWNER_ID,
