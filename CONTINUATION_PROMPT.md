...
**Current totals (as of April 13, 2026, after Task #43):**

| Category | Count | Notes |
|---|---|---|
| **REAL — confirmed AI agents** | **20** | Jasper, Copywriter, Video Specialist, Calendar Coordinator, Asset Generator, Growth Strategist, SEO Expert, LinkedIn Expert, TikTok Expert, Twitter/X Expert, Facebook Ads Expert, Growth Analyst, UX/UI Architect, Funnel Engineer, Workflow Optimizer, Copy Specialist, UX/UI Specialist, Funnel Pathologist, **Email Specialist** |
| **TEMPLATE — needs rebuild** | **18** | Hand-coded switch/lookup engines with zero LLM calls. |
...
**Progress: 20 REAL / 38 total candidates (REAL + TEMPLATE) = 53% done.** Content department COMPLETE (4/4 REAL, `delegate_to_content` live). Marketing department COMPLETE (6/6 REAL, `delegate_to_marketing` live). Builder department COMPLETE (3/3 REAL, `delegate_to_builder` live). **Architect department COMPLETE (3/3 REAL, `delegate_to_architect` live).** **Outreach department 1/2** — Email Specialist ✓ (Task #43), SMS Specialist pending. Voice AI Specialist is classified INFRA (telephony wrapper, not an LLM rebuild candidate). **Full Jasper → Architect → Builder pipeline is live.** **Next: Task #44 — rebuild SMS Specialist.** Then Task #45 rewires `delegate_to_outreach` from NOT_WIRED to live (includes a one-time OutreachManager dispatch update to call the new compose_email action — same two-step pattern as Tasks #41/#42).
