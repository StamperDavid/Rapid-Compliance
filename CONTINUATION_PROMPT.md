...
Branch: dev
Last Updated: April 13, 2026 (Tasks #61 + #62 — Architect-layer specialists renamed to `*_STRATEGIST` suffix so layer boundary is visible from the identifier; Scraper Specialist rebuilt as hybrid LLM + real-scraper Intelligence specialist — upstream `scrapeWebsite`/`scrapeAboutPage`/`scrapeCareersPage` fetch raw HTML, new GM-backed LLM layer turns scraped prose into structured `ScrapeAnalysisResult` while preserving the existing `ScrapeResult` shape for downstream consumers. Intelligence dept 1/5 REAL, 22 total REAL specialists, 58% done)
...
**Current totals (as of April 13, 2026, after Tasks #61 + #62):**

| Category | Count | Notes |
|---|---|---|
| **REAL — confirmed AI agents** | **22** | Jasper, Copywriter, Video Specialist, Calendar Coordinator, Asset Generator, Growth Strategist, SEO Expert, LinkedIn Expert, TikTok Expert, Twitter/X Expert, Facebook Ads Expert, Growth Analyst, UX/UI Architect, Funnel Engineer, Workflow Optimizer, Copy Strategist, UX/UI Strategist, Funnel Strategist, Email Specialist, SMS Specialist, **Scraper Specialist (Task #62)** |
| **TEMPLATE — needs rebuild** | **16** | Hand-coded switch/lookup engines with zero LLM calls. |
...
**Intelligence department (5 specialists — 1/5 REAL, 4/5 TEMPLATE):**
